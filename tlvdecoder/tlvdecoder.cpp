...
char app_interchange_profile[2+1];
char dedicated_file_name[16+1];
char issuer_authentication_data[16+1];
char terminal_verification_result[5+1];
char transaction_date[3+1];
char transaction_type[1+1];
char transaction_currency_code[2+1];
char amount_authorized[6+1];
char amount_other[6+1];
char application_identifier[16+1];
char application_usage_control[2+1];
char terminal_application_version_number[2+1];
char issuer_application_data[32+1];
char terminal_country_code[2+1];
char interface_device_serial_number[8+1];
char application_crpytogram[8+1];
char cryptogram_information_data[1+1];
char terminal_capability[3+1];
char cardholder_verfication_method_result[3+1];
char terminal_type[1+1];
char application_transaction_counter[2+1];
char unpredictable_number[4+1];
char transaction_sequence_counter[4+1];
char transaction_category_code[1+1];
char issuer_script_result[25+1];
char card_product_identification[16+1];
char issuer_authorization_code[6+1];
};
